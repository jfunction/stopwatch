...
class PreferencesDialog(gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesStopwatchDialog')
        new_object = builder.get_object("preferences_stopwatch_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesStopwatchDialog
        instance.
