...
import gtk
import logging
logger = logging.getLogger('stopwatch_lib')

from . helpers import get_builder, show_uri, get_help_uri
from . preferences import preferences

# This class is meant to be subclassed by StopwatchWindow.  It provides
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseStopwatchWindow object.
        """
        builder = get_builder('StopwatchWindow')
        new_object = builder.get_object("stopwatch_window")
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for stopwatch."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for stopwatch."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the StopwatchWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the StopwatchWindow is closed."""
