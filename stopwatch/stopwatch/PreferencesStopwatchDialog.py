...
from stopwatch_lib.PreferencesDialog import PreferencesDialog

class PreferencesStopwatchDialog(PreferencesDialog):
    __gtype_name__ = "PreferencesStopwatchDialog"

    def finish_initializing(self, builder): # pylint: disable=E1002
        """Set up the preferences dialog"""
        super(PreferencesStopwatchDialog, self).finish_initializing(builder)
