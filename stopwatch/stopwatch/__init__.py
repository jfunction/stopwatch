...
from stopwatch_lib import set_up_logging, preferences, get_version
...
def parse_options():
    ...
    parser.add_option(
        ...
        help=_("Show debug messages (-vv debugs stopwatch_lib also)"))
...
def main():
    ...
    # Run the application.    
    window = StopwatchWindow.StopwatchWindow()
    window.show()
    gtk.main()
